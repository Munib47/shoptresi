...
! function(a, b) {
    ...
    return b.defaults = {
        ...
        var b = this;
        a("body").on("click", "a[rel^=lightbox], area[rel^=lightbox], [data-lightbox], area[data-lightbox]", function(c) {
        ...
        if ("undefined" != typeof this.album[this.currentImageIndex].title && "" !== this.album[this.currentImageIndex].title && this.$lightbox.find(".lb-caption").html(this.album[this.currentImageIndex].title).fadeIn("fast").find("a").on("click", function(b) {
                void 0 !== a(this).attr("target") ? window.open(a(this).attr("data-href"), a(this).attr("target")) : location.href = a(this).attr("data-href")
