            ...
            csJq.getJSON("/cart.json", function (cart) {   
                ...
                if(result_data.generalSettingData.gen_shipping_price_setting == 1 && planStatus && hasError){
                    ...
                    if(window.hasdiscount == true){
                        ...
                        dataLocation1.discount_code =  csJq("input[name='pickup-discount']").val();
                    }
                    ...
                    error: function (error) {
                        ...
                        if(result.success){
    						//console.log(result.checkout_url+'?locale=en-SBZPICKUP');
...
function updateCall(csPostAttr) {
...
function csUpdateCart(haswidget, hasnoattr = 0) {
    csJq.getJSON("/cart.json", function (cart) {
        ...
        if (cart.item_count > 0) {
                var csOrderTypeValue = csJq("#csOrderTypeValue").val(), csLocationIdName = csJq("#csLocationId").attr("name"), csLocationValue = csJq("#csLocationId").val(), csLocationName = csJq('.cs-radio-card[data-location-mainid="' + csLocationValue + '"] h6').text().trim(), csLocationAttr = csJq("#csDeliveryLocationValue").attr("name"), csDeliveryZipValue = csJq("#csDeliveryZipValue").val(), csDeliveryZipAttr = csJq("#csDeliveryZipValue").attr("name"), csOrderTypeAttr = csJq("#csOrderTypeValue").attr("name"), csDeliveryDayValue = csJq(csDelvDayVal).val(), csDeliveryDateValue = csJq(csDelvDateVal).val(), csDeliveryTimeValue = csJq(csDelvTimeVal).val(), csDeliveryDayAttr = csJq(csDelvDayVal).attr("name"), csDeliveryDateAttr = csJq(csDelvDateVal).attr("name"), csDeliveryTimeAttr = csJq(csDelvTimeVal).attr("name"), csPickupDayValue = csJq(csPickDayVal).val(), csPickupDateValue = csJq(csPickDateVal).val(), csPickupTimeValue = csJq("#csPickupTimeValue").val(), csPickupTimeAttr = csJq("#csPickupTimeValue").attr("name"), csPickupDayAttr = csJq(csPickDayVal).attr("name"), csPickupDateAttr = csJq(csPickDateVal).attr("name"), csshippingDateValue = csJq("#csShippingDateValue").val(), csshippingDateAttr = csJq("#csShippingDateValue").attr("name"), csshippingDayValue = csJq("#csShippingDayValue").val(), csshippingDayAttr = csJq("#csShippingDayValue").attr("name"), csShippingTimeValue = csJq("#csShippingTimeValue").val(), csShippingTimeAttr = csJq("#csShippingTimeValue").attr("name"), csLoactionAddressAttr = csJq("#csLocationAddress1").attr("name"), csLoactionAddressValue = csJq("#csLocationAddress1").val(),
                  csPostData = {},
                  csPostAttr = {},
...
function htmlDataWidget(result_data){
    ...
    getForm = csJq(csCartFormSelector).length; 
...
<div class="CS-custom-tab-section tab-view quality-sticker-tab ${generalData.layout_style_selection != '' ? 'cs-layout-tab-'+generalData.layout_style_selection : 'cs-layout-tab-0'}">
    ...
    <div id="required-error"></div>
      <input type="hidden" name="Type Of Order" class="csIgnoreCngEvent" id="csOrderTypeValue" value="Shipping">
      <input type="hidden" name="${generalData.gen_loc_day_text}" class="csIgnoreCngEvent" id="csDeliveryDayValue">
      <input type="hidden" name="${generalData.gen_loc_date_text}" class="csIgnoreCngEvent" id="csDeliveryDateValue">
      <input type="hidden" name="${generalData.gen_loc_time_text}" class="csIgnoreCngEvent" id="csDeliveryTimeValue">
      <input type="hidden" name="${generalData.gen_pickup_day_text}" class="csIgnoreCngEvent" id="csPickupDayValue">
      <input type="hidden" name="${generalData.gen_pickup_date_text}" class="csIgnoreCngEvent" id="csPickupDateValue">
      <input type="hidden" name="${generalData.gen_pickup_time_text}" class="csIgnoreCngEvent" id="csPickupTimeValue">
      <input type="hidden" name="${generalData.gen_shipping_day_text}" class="csIgnoreCngEvent" id="csShippingDayValue">
      <input type="hidden" name="${generalData.gen_shipping_date_text}" class="csIgnoreCngEvent" id="csShippingDateValue">
      <input type="hidden" name="${generalData.gen_shipping_time_text}" class="csIgnoreCngEvent" id="csShippingTimeValue">
      <input type="hidden" name="Pickup Address" class="csIgnoreCngEvent" id="csLocationAddress1">
      ...
      <input type="hidden" class="csIgnoreCngEvent" name="LocationId" id="csLocationId">
      <input type="hidden" name="zip" class="csIgnoreCngEvent" id="csDeliveryZipValue">
      <input type="hidden" name="Pickup Location" class="csIgnoreCngEvent" id="csDeliveryLocationValue" value="">
